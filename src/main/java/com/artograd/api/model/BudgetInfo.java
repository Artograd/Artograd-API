...
public class BudgetInfo {
	@Schema(description = "Initial estimation of budget needed for creation and delivery of art object")
	private double initialEstimate;
	
	@Schema(description = "Refined estimation of budget needed for creation and delivery of art object")
