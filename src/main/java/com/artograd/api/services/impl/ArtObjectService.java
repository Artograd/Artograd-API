...
public class ArtObjectService implements IArtObjectService {
    ...
    public Optional<ArtObject> createArtObject(String tenderId, String winnerProposalId) {
        return tenderService.getTender(tenderId).flatMap(tender ->
            proposalService.getProposal(tenderId, winnerProposalId).map(proposal -> {
    ...
    private void setArtObjectFromTenderAndProposal(ArtObject artObject, Tender tender, Proposal proposal) {
