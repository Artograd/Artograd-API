package com.artograd.api.filter;
...
/**
 * Simple Filter implementation that looks for a Cognito identity id in the API Gateway request
 * context and stores the value in a request attribute. The filter is registered with
 * aws-serverless-java-container in the onStartup method from the {@link
 * com.amazonaws.serverless.sample.springboot3.StreamLambdaHandler} class.
 */
